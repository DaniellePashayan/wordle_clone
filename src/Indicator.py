...
class Indicator:
    ...
    def draw(self):
        ...
        self.text_surface = pygame.font.Font(FONT, LETTER_SIZE).render(self.letter, True, pygame.Color("white"))
        self.text_rect = self.text_surface.get_rect(center=(self.x + INDICATOR_SIZE // 2, self.y + INDICATOR_SIZE // 2))
